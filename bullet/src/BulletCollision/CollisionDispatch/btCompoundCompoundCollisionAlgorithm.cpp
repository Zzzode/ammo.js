...
struct btCompoundCompoundLeafCallback : btDbvt::ICollide
{
	...
	btCompoundCompoundLeafCallback(const btCollisionObjectWrapper* compound1ObjWrap,
		...
		: m_compound0ColObjWrap(compound1ObjWrap), m_compound1ColObjWrap(compound0ObjWrap), m_dispatcher(dispatcher), m_dispatchInfo(dispatchInfo), m_resultOut(resultOut), m_childCollisionAlgorithmCache(childAlgorithmsCache), m_sharedManifold(sharedManifold), m_numOverlapPairs(0)
	{
	}
